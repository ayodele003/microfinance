...
$titleError = "Title is required. Please choose a Title.";
...
$fnameError = "First Name is required. Please Fill your First Name.";
...
$lnameError = "Last Name is required. Please Fill in your Last Name";
...
$dob_mmError = "Date of Birth is required. Fill in your Date of Birth.";
...
if (empty($_POST["sex"])) {
$sexError = "Gender is required. Select Gender";
...
if (empty($_POST["ms"])) {
$msError = "Marital Status is required. Choose Your Marital Status";
...
$dir = "../../campusplus/upload/CampusFiles/"; // Upload directory
...
$AcctType = "New Polaris Campus Plus";
...
$RefCode = 'SB-CAMPUS-' .date("d") . date("m") . date("Y") .'-'. $zrefno;	
$DateOfBirth = $_POST['DateOfBirth'];

//if (stristr($_SERVER['HTTP_REFERER'],"https://accounts.skyebankng.com/skyeFlex/gform.php")){

$fx=mysql_query("select Fname, Lname, DateOfBirth, CellPhone from campus_accounts WHERE Fname = '$fname' AND Lname='$lname' AND DateOfBirth = '$DateOfBirth' AND CellPhone='$CellPhone'") or die(mysql_error());
...
$fxx=mysql_query("select CellPhone from campus_accounts WHERE CellPhone='$CellPhone'") or die(mysql_error());
$numrows = mysql_num_rows($fxx);
if($numrows){
echo "Dear $fname, <br><br> Sorry, we noticed that an existing Polaris Campus application match your phone number. Duplicate phone numbers are not allowed."; 
exit;
}


$sqli = "INSERT INTO campus_accounts (RefCode, AcctType, Title, Fname, Mname, Lname, FullName, DateOfBirth, PlaceOfBirth, StateofOrigin, Religion, LGA, 
Sex, MaritalStatus, ResidentialAddress, NBS, RPostal, RCity, RState, RCountry, MailingAddress, Telephone, CellPhone, Email,EmployStatus, NextOfKin, Relationship,
 AddressOfNOK, EmailOfNOK, PhoneOfNOK, Services, Security, PreferredBranch, Referral, Passport, Signature, Identification,bvn, Status, StatusDate, Comments, DateApproved, DateDeclined, DateTreated, DateFiled, AcctNum) 
VALUES ('$RefCode', '$AcctType', '$title', '$fname', '$mname', '$lname', '$FullName', '$DateOfBirth', '$PlaceOfBirth', '$StateofOrigin', '$Religion', '$LGA', '$Sex',
 '$MaritalStatus', '$ResidentialAddress', '$nbs', '$rpostal', '$rcity', '$rstate', '$rcountry', '$MailingAddress', '$TelePhone', '$CellPhone', '$Email', 
 '$EmployStatus','$NextOfKin', '$Relationship', '$AddressOfNOK', '', 0, '".$Services[0].", ".$Services[1].", ".$Services[2]."', '$Security', '$PreferredBranch',
 '$Referral', '{$puniq_file_name}', '{$suniq_file_name}', '{$iduniq_file_name}','$bvn', '', CURRENT_TIMESTAMP, '', '', '', '', '', '')";		   	   
if (mysql_query($sqli)) {
...
$messagex = "<table width=550 border=0 cellspacing=0 cellpadding=5> <tr>
<td bgcolor=#efefef><table width=600 border=0 cellspacing=0 cellpadding=5>
<tr><td bgcolor=#FFFFFF style=border-top:2px solid #efefef;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px><p align=center><strong>Polaris Campus Plus Application</strong></p><blockquote>Dear $FullName, <br><br>Your application for $AcctType has been successfully logged into our system.<br><br>We are in the process of creating your new account. Please quote the Reference Code below in any future correspondence regarding this application.<br><br><b>Reference Code: $RefCode</b><br><br><br><br>Please, do not hesitate to contact us via our email: yescenter@polarisbanklimited.com and phone numbers:01-4482100 or 08069880000, for any questions or enquiries you may have.<br><br><br>Best Regards. <br><br><br>Polaris Campus Plus Team</td></tr></table></td></tr></table>";
...
<td bgcolor=#efefef><table width=600 border=0 cellspacing=0 cellpadding=5>
<tr><td bgcolor=#FFFFFF style=border-top:2px solid #efefef;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px><h3 align=center><strong>Polaris Campus Plus Online Application</strong></h3><blockquote>New application for $AcctType has been logged into the system.<br><br>See summary below:<br><br><b>Name of Applicant:$FullName<br>Reference Code: $RefCode<br>Cell Phone: $CellPhone<br><br>Email: $Email<br>
